...
var DaySlot = function (_React$Component) {
  ...
  function DaySlot() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DaySlot.__proto__ || Object.getPrototypeOf(DaySlot)).call.apply(_ref, [this].concat(args))), _this), _initialiseProps.call(_this), _temp), _possibleConstructorReturn(_this, _ret);
  }
    ...
    return styledEvents.map(function (_ref2, idx) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            style: _extends({}, event.style, xStyle, (_extends2 = {
              top: top + '%',
              height: height + '%'
