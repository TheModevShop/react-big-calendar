...
var dates = _extends({}, _dateArithmetic2.default, {
  ...
  range: function range(start, end) {
    ...
    var inc = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
  ...
  between: function between(start, end, date) {
    var unit = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  ...
  sameWeekDay: function sameWeekDay(dateA, dateB, dow) {
    if (dateA && dateB) {
