...
var Formats = (_Formats = {}, _defineProperty(_Formats, _constants.views.MONTH, 'monthHeaderFormat'), _defineProperty(_Formats, _constants.views.WEEK, 'dayRangeHeaderFormat'), _defineProperty(_Formats, _constants.views.WORK_WEEK, 'dayRangeHeaderFormat'), _defineProperty(_Formats, _constants.views.DAY, 'dayHeaderFormat'), _defineProperty(_Formats, _constants.views.AGENDA, 'agendaHeaderFormat'), _Formats);
