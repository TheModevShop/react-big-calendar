  ...
  _createClass(TimeColumn, [{
    ...
    value: function renderTimeSliceGroup(key, isNow, date) {
      var _props = this.props,
          ...
          selectedServices = _props.selectedServices;

      var hoursForDay = this.props.businessHours[(0, _momentTimezone2.default)(date).format('YYYY-MM-DD')];
      var hoursForDayArray = [];
      if (hoursForDay) {
        var i = 0;
        while (i <= timeslots - 1) {
