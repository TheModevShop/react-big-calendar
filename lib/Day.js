  ...
  _createClass(Day, [{
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          props = _objectWithoutProperties(_props3, ['date', 'calendars']);
      ...
      if (calendars && calendars.length) {
        ...
        calendarComponents = _react2.default.createElement(_TimeGrid2.default, _extends({ key: 'time-grid-calendar' }, props, { range: range, eventOffset: 10 }));
      }
