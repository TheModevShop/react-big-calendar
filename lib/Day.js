  ...
  _createClass(Day, [{
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          selectedServices = _props3.selectedServices,
          props = _objectWithoutProperties(_props3, ['date', 'calendars', 'businessHours', 'selectedServices']);
      ...
      if (calendars && calendars.length) {
        ...
        calendarComponents = _react2.default.createElement(_TimeGrid2.default, _extends({ key: 'time-grid-calendar' }, props, { selectedServices: selectedServices, businessHours: businessHours, range: range, eventOffset: 10 }));
      }
